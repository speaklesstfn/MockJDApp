...
export default class HomePage extends Component {
    ...
    componentWillMount() {//获取listview要显示的数据内容
        fetch('http://m.jd.com/index/recommend.action?_format_=json&page=1')
            ...
            .then((str) => {
                ...
                var ds = this.state.dataList.cloneWithRows(rows);
                this.setState({dataList: ds});
            });
    }
    ...
    _onRecommendClick(wareId) {//跳转到详情页
...
alignItems: 'center'}}>
                ...
                <TouchableWithoutFeedback
                    ...
                    <View style={{flex:1,alignItems:'center'}}>
                        <Image
                            resizeMode={'stretch'}
                            source={{uri:rowData.right.imageurl}}
                            style={{width:len,height:len}}/>
    ...
    render() {
        return (
            <ListView
                ...
                renderHeader={()=>{
                return ( //此处返回的是listview的头部，这里包括轮播图片，八个功能按钮，分隔线以及一个“猜你喜欢”文字
